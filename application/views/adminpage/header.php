			...
			<div class="sidebar-nav slimscrollsidebar" id="sidebar-menu">
				...
				<ul class="nav" id="side-menu">
					<li style="padding: 70px 0 0;">
						<a href="<?php echo base_url(); ?>dashboard" class="waves-effect"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i>Dashboard</a>
					</li>
					<li>
					...
					<li>
						 <a href="student.php" class="waves-effect"><i class="fa fa-graduation-cap fa-fw" aria-hidden="true"></i>Student</a>
					</li>
					<li>
						<a href="#" class="waves-effect"><img src="<?php echo base_url(); ?>assets/adminpagestyles/plugins/images/users/teacher.png" alt="user-img" width="30" class="img-circle" style="margin-left: -2px">Teacher</a>
					</li>
					<li>
						<a href="#" class="waves-effect"><i class="fa fa-users" aria-hidden="true"></i> Section</a>
					</li>
					<li>
						<a href="#" class="waves-effect"><img src="<?php echo base_url(); ?>assets/adminpagestyles/plugins/images/users/account.png" alt="user-img" width="30" class="img-circle" style="margin-left: -7px">Accounts</a>
					</li>
					<li>
